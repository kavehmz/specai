...
7. **Open questions are flagged, never silently resolved.** A place where the spec and reality (or
   two specs) may diverge gets an "Open questions" entry with the unresolved choice stated — not a
   quiet decision buried in prose.
